...
const AddComment: React.FC<AddCommentProps> = (props) => {
    ...
    return <div className={classes.addCommentContainer}>
        <img src={props.imageSrc === null ? BlankProfilePicture : user?.user.profileImage} className={classes.img} />
        <input type='text' className={classes.input} value={text} placeholder='Write a comment...' onChange={(event) => {setText(event.target.value)}}/>
