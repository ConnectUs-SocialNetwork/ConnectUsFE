  ...
  return (
    <div className={classes.container}>
      ...
      <div className={classes.buttomContainer}>
        ...
        {!user.heSentFriendRequest && user.requestSentByMe && <button className={classes.addButton}>Unsend request</button>}
        {!user.requestSentByMe && user.heSentFriendRequest && <button className={classes.addButton}>Accept request</button>}
        <button
